...
% Stationary droplet trapped by a solid boundary in a semi-periodic domain 
% with an array of circular pillars and bulk liquid
mat_name = 'trapped_droplet_';
comp_name = '../../test_data/matlab_trapped_droplet_';
save_data(mat_name, comp_name);

% Droplet moving through an array of circular pillars and bulk liquid
mat_name = 'pillars_';
comp_name = '../../test_data/matlab_flowing_droplet_';
save_data(mat_name, comp_name);
