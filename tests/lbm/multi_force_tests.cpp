...
bool single_phase_empty_test()
{
	...
	const std::string fname_ini("multi_force_empty_ini");
	const std::string fname_stream("multi_force_empty_stream");
	// File with geometry
...
bool single_phase_x_walls_test()
{
	...
	// Filename templates
	const std::string path("test_data/");
	const std::string fname_ini("multi_force_x_walls_ini");
	const std::string fname_stream("multi_force_x_walls_stream");
	// File with geometry
...
bool single_phase_y_walls_test()
{
	...
	// Filename templates
	const std::string path("test_data/");
	const std::string fname_ini("multi_force_y_walls_ini");
	const std::string fname_stream("multi_force_y_walls_stream");
...
bool single_phase_array_no_walls_test()
{
	...
	// Filename templates
	const std::string path("test_data/");
	const std::string fname_ini("multi_force_array_no_walls_ini");
	const std::string fname_stream("multi_force_array_no_walls_stream");
	// File with geometry
...
bool single_phase_array_x_walls_test()
{
	...
	// Filename templates
	const std::string path("test_data/");
	const std::string fname_ini("multi_force_array_x_walls_ini");
	const std::string fname_stream("multi_force_array_x_walls_stream");
	// File with geometry
